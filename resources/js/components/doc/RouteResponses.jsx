...
export default function RouteResponses({ responses }) {
    ...
    const contentTypeIcons = {
        'text/html': { icon: '🌐', label: 'HTML Response', color: 'text-blue-500 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800' },
        'redirect': { icon: '↪️', label: 'Redirect', color: 'text-purple-500 bg-purple-50 dark:bg-purple-900/20 border-purple-200 dark:border-purple-800' },
        'application/octet-stream': { icon: '📄', label: 'File Download', color: 'text-orange-500 bg-orange-50 dark:bg-orange-900/20 border-orange-200 dark:border-orange-800' },
        'no-content': { icon: '✓', label: 'No Content', color: 'text-slate-500 bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700' },
    };
            ...
            <React.Fragment key={`${node.key}-${depth}-${Math.random()}`}>
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4 py-3 border-b border-slate-100 dark:border-slate-800/60 transition-colors hover:bg-slate-50 dark:hover:bg-slate-900/40">
                    ...
                    >
                        ...
                        <span className="text-emerald-600 dark:text-emerald-400 font-bold break-all">{node.key}</span>
                    ...
                    <div className="flex-[1.5] text-[13px] text-slate-600 dark:text-slate-400 px-2 sm:px-0 break-words">
